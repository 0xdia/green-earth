...
python3 get-pip.py
python3 -m pip install azure-identity psycopg2-binary

# Add script that fetch data
cat > /usr/local/bin/fetch_data.py <<HEREDOC
import traceback
...
MODULES_FILE = "/web-content/modules.txt"
GRADES_FILE = "/web-content/grades.txt"
